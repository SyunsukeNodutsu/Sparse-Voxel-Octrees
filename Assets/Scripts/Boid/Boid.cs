...
public class Boid : MonoBehaviour
{
    ...
    private void UpdateMove()
    {
        ...
        // X回転(Y移動量)制限 TODO: degreeで指定
        if (true)
        {
            var clampVelocityY = 1.0f;

            var newY = Mathf.Clamp(Velocity.y, -clampVelocityY, clampVelocityY);
    ...
    /// <summary>群れの形成 分離.整列.結合の3要素を計算</summary>
